...
class Code_Completion_Baseline:
    ...
    def create_network(self):
        ...
        #self.net = tflearn.embedding(20000, len(self.string_to_number), len(self.string_to_number))
        ...
        self.net = tflearn.regression(self.net, optimizer='adam',
    ...
    def train(self, token_lists, model_file):
        ...
        #(xs, ys) = numpy.reshape((xs, ys), (-1, 64, len(self.string_to_number)))
        self.create_network()
        self.model.fit(xs, ys, n_epoch=1, validation_set=0.1, show_metric=True, snapshot_step=100)
        self.model.save(model_file)
        #acc = self.model.evaluate(xs, ys)
        #print("\n%s: %.2f%%" % (self.model.metrics_names[1], acc[1]*100))
